...
export default function Proyectos() {
  ...
  return (
    <section id="Projects" className="Projects">
      ...
      <p className="Projects-P">Aquí podes ver algunos proyectos en los que trabajé</p>
      ...
      <FaArrowAltCircleRight className="Right-Arrow" onClick={Next} />
              ...
              <a className={slide.visit ? "Project-Visit" : "Project-NoVisit"} href={slide.link} target="_blank" rel="noreferrer">VISITAR</a>
              </>
              )}
            </div>
          );
